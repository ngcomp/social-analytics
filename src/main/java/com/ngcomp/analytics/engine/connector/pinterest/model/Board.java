...
public class Board extends Data {
	...
	public String toString() {
		return "Board [href=" + href + ", name=" + name + ", source=" + source
				+ ", boardURL=" + boardURL + "]";
	}
	...
	public Map<String, String[]> getHBaseRowMap() {
		...
		quals[5] = "post"; vals[5] = gson.toJson(this, Board.class);
		...
		quals[12] = "createdAt"; vals[12] = String.valueOf(this.getBoardURL());
