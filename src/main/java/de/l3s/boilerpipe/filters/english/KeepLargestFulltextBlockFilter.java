...
/**
 * Keeps the largest {@link de.l3s.boilerpipe.document.TextBlock} only (by the number of words). In case of
 ...
 *
 * As opposed to {@link de.l3s.boilerpipe.filters.heuristics.KeepLargestBlockFilter}, the number of words are
 * computed using {@link de.l3s.boilerpipe.filters.english.HeuristicFilterBase#getNumFullTextWords(de.l3s.boilerpipe.document.TextBlock)}, which only counts
 ...
 * may lead to suboptimal results. You better use {@link de.l3s.boilerpipe.filters.heuristics.KeepLargestBlockFilter} instead, which
