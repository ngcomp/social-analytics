 ...
 * 
 * NOTE: You might consider using the {@link de.l3s.boilerpipe.filters.simple.SplitParagraphBlocksFilter}
 * upstream.
 * 
 * @author Christian Kohlschütter
 * @see de.l3s.boilerpipe.filters.simple.SplitParagraphBlocksFilter
 */
