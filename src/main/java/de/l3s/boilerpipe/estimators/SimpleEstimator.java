...
/**
 * Estimates the "goodness" of a {@link de.l3s.boilerpipe.BoilerpipeExtractor} on a given document.
 * 
...
public final class SimpleEstimator {
    ...
    /**
     * Given the statistics of the document before and after applying the {@link de.l3s.boilerpipe.BoilerpipeExtractor},
     * can we regard the extraction quality (too) low?
     *
     * Works well with {@link de.l3s.boilerpipe.extractors.DefaultExtractor}, {@link de.l3s.boilerpipe.extractors.ArticleExtractor} and others.
     * 
     * @param dsBefore
     * @param dsAfter
