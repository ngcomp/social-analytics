...
/**
 * Parses an {@link org.xml.sax.InputSource} using SAX and returns a {@link de.l3s.boilerpipe.document.TextDocument}.
 *
...
public final class BoilerpipeSAXInput implements BoilerpipeInput {
    ...
    /**
     * Retrieves the {@link de.l3s.boilerpipe.document.TextDocument} using a default HTML parser.
     */
    ...
    /**
     * Retrieves the {@link de.l3s.boilerpipe.document.TextDocument} using the given HTML parser.
     * 
     * @param parser The parser used to transform the input into boilerpipe's internal representation.
     * @return The retrieved {@link de.l3s.boilerpipe.document.TextDocument}
