...
public class BoilerpipeHTMLParser extends AbstractSAXParser implements BoilerpipeDocumentSource {
    ...
    /**
     * Constructs a {@link de.l3s.boilerpipe.sax.BoilerpipeHTMLParser} using the given {@link de.l3s.boilerpipe.sax.BoilerpipeHTMLContentHandler}.
     *
    ...
    /**
     * Returns a {@link de.l3s.boilerpipe.document.TextDocument} containing the extracted {@link de.l3s.boilerpipe.document.TextBlock}
     * s. NOTE: Only call this after {@link #parse(org.xml.sax.InputSource)}.
     *
     * @return The {@link de.l3s.boilerpipe.document.TextDocument}
     */
