 ...
 * </ul>
 *
 * @see org.cyberneko.html.HTMLElements
 *
 * @author Andy Clark
...
public class HTMLTagBalancer
    ...
    public void startDocument(XMLLocator locator, String encoding, 
        ...
        if (fragmentContextStack_ != null) {
        	...
        	for (int i=0; i<fragmentContextStack_.length; ++i) {
            	...
            	final Element elt = org.cyberneko.html.HTMLElements.getElement(name.localpart);
    ...
    public void startElement(final QName elem, XMLAttributes attrs, final Augmentations augs)
        ...
        if (isForcedCreation && (elementCode == org.cyberneko.html.HTMLElements.TABLE || elementCode == org.cyberneko.html.HTMLElements.SELECT)) {
        	return; // don't accept creation
        }

        // ignore multiple html, head, body elements
		if (fSeenRootElement && elementCode == org.cyberneko.html.HTMLElements.HTML) {
        	notifyDiscardedStartElement(elem, attrs, augs);
            return;
        }
        if (elementCode == org.cyberneko.html.HTMLElements.HEAD) {
            if (fSeenHeadElement) {
            	notifyDiscardedStartElement(elem, attrs, augs);
                return;
            }
        ...
        else if (elementCode == org.cyberneko.html.HTMLElements.FRAMESET) {
        	consumeBufferedEndElements(); // </head> (if any) has been buffered
        }
        else if (elementCode == org.cyberneko.html.HTMLElements.BODY) {
        ...
        else if (elementCode == org.cyberneko.html.HTMLElements.FORM) {
        	if (fOpenedForm) {
            	notifyDiscardedStartElement(elem, attrs, augs);
        		return;
        	}
        ...
        else if (elementCode == org.cyberneko.html.HTMLElements.UNKNOWN) {
        	consumeBufferedEndElements();
        }
        ...
        if (element.parent != null) {
        	if (!fSeenRootElement && !fDocumentFragment) {
                ...
                if (preferedParent.code != org.cyberneko.html.HTMLElements.HEAD || (!fSeenBodyElement && !fDocumentFragment)) {
        ...
        if ((fElementStack.top > 1 
        		&& (fElementStack.peek().element.code == org.cyberneko.html.HTMLElements.SCRIPT))
        		|| fElementStack.top > 2 && fElementStack.data[fElementStack.top-2].element.code == org.cyberneko.html.HTMLElements.HEAD) {
        ...
        else if (elementCode == org.cyberneko.html.HTMLElements.TABLE) {
        ...
        if (elementCode == org.cyberneko.html.HTMLElements.BODY) {
        	lostText_.refeed(this);
        }
    ...
    public void emptyElement(final QName element, XMLAttributes attrs, Augmentations augs)
        ...
        if (elem.isEmpty() || elem.code == org.cyberneko.html.HTMLElements.UNKNOWN) {
    ...
    public void startGeneralEntity(String name, 
        ...
        if (!fDocumentFragment) {
            ...
            if (!insertBody) {
                ...
                if (info.element.code == org.cyberneko.html.HTMLElements.HEAD ||
                    info.element.code == org.cyberneko.html.HTMLElements.HTML) {
    ...
    public void endElement(final QName element, final Augmentations augs) throws XNIException {
        ...
        if (!fIgnoreOutsideContent &&
            (elem.code == org.cyberneko.html.HTMLElements.BODY || elem.code == org.cyberneko.html.HTMLElements.HTML)) {
        	endElementsBuffer_.add(new ElementEntry(element, augs));
            return;
        }

        // check for end of document
        if (elem.code == org.cyberneko.html.HTMLElements.HTML) {
            fSeenRootElementEnd = true;
        }
        else if (elem.code == org.cyberneko.html.HTMLElements.FORM) {
        	fOpenedForm = false;
        }
        else if (elem.code == org.cyberneko.html.HTMLElements.HEAD && !forcedEndElement) {
        ...
        if (depth == -1) {
        	if (elem.code == org.cyberneko.html.HTMLElements.P) {
        ...
        if (depth > 1 && elem.isInline()) {
            ...
            for (int i = 0; i < depth - 1; i++) {
                ...
                if (pelem.isInline() || pelem.code == org.cyberneko.html.HTMLElements.FONT) { // TODO: investigate if only FONT
