...
public class Main {
    ...
    private void setOptionsTraining() {
        ...
        km.setDirName("/Users/rparashar/Downloads/kea-5.0_full/testdocs/en/train");

        // 2. Name of the model -- give the path to where the model is to be stored and its name
        km.setModelName("/Users/rparashar/Downloads/kea-5.0_full/testdocs/en/model");
...
//		 B. optional arguments if you want to change the defaults
    ...
    private void setOptionsTesting(String m_testdir) {
        ...
        ke.setModelName("/Users/rparashar/Downloads/kea-5.0_full/testdocs/en/model");
...
//
        String m_testdir = "/Users/rparashar/Downloads/kea-5.0_full/testdocs/en/test";
