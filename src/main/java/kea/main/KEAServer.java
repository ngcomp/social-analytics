...
public class KEAServer {
    ...
    public String[] extractKeyphrasesFromURL(String urlS) throws BoilerpipeProcessingException, MalformedURLException {

        //System.out.println(urlS);

        URL url = new URL(urlS);
        String document = ArticleExtractor.INSTANCE.getText(url);
    ...
    public String[] extractKeyphrasesFromString(String document) throws BoilerpipeProcessingException, MalformedURLException {
    ...
    public static void main(String[] args) {
        ...
        model = PropUtils.getModalFile();
        if (s > 1 ) {
            // maybe it's a number for port
            try {
                port = 8080; //Integer.parseInt(8080);
        ...
        System.out.println("Accepting request from addresses: " + localhost);
    ...
    private List<Instance> myExtractKeyphrases(String document) throws Exception {
